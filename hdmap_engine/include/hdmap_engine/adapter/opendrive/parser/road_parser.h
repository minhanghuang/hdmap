#ifndef HDMAP_ENGINE_ADAPTER_OPENDRIVE_PARSER_ROAD_H_
#define HDMAP_ENGINE_ADAPTER_OPENDRIVE_PARSER_ROAD_H_
...
#endif  // HDMAP_ENGINE_ADAPTER_OPENDRIVE_PARSER_ROAD_H_
